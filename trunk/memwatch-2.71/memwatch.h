...
//#define ENABLEMWFILEWRITES 1
#define fprintf(a, fmt, ...) _cprintf(fmt, __VA_ARGS__)
...
*/
#ifndef __MEMWATCH_C
//extern const unsigned long mwCounter;		//delete by Laid, 24.11.2013
extern unsigned long mwCounter;
#endif
